...
// Generate OpenAPI client code using bun x
await $`bun x @hey-api/openapi-ts --input ${path.join(root, "packages/sdk/openapi.json")} --output ${path.join(dir, "dist/v2/gen/client")} --client fetch --plugins @hey-api/sdk/client`.cwd(dir)
